...
<input type="button" value="Be a Kiosk" onclick="window.location='/dev/kiosk.php'"/>
<input type="button" value="Fullscreen Kiosk" onclick="window.location='/dev/fullscreen.php'"/>
<input type="button" value="Replay Kiosk" onclick="window.location='/dev/replay.php'"/>
<br/>
